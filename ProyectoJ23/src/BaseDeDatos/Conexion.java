...
public class Conexion {
    ...
    private static final String JDBC_URL = "jdbc:oracle:thin:@basededatosproyectojava_high"; // - REEMPLAZA 'testdb_high' EN EL ARCHIVO TNSNAMES.ORA APARECE AL INICIO [NOMBRE DE LA DB]_HIGH";
    ...
    public Connection obtenerConexion() {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/basededatosproyectojava", "ADMIN", "Walletbasededatos1.");
